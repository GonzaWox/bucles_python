...
promedio_temperaturas = suma_total / cantidad_temperaturas

print(f"La suma de las temperaturas es: {suma_total}")
print(f"La cantidad de temperaturas es: {cantidad_temperaturas}")
print(f"El promedio de las temperaturas es: {promedio_temperaturas}")
